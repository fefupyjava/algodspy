![](https://travis-ci.org/fefupyjava/algodspy.svg?branch=master&status=started)
...
1. Соблюдать стандарт оформления кода [PEP8](https://pep8.ru/doc/pep8/).
2. По умолчанию весь код писать в парадигме [объектно-ориентированного программирования](https://younglinux.info/oopython.php).
3. Именование всего и вся согласно PEP8, но вот ещё раз [памятка](https://visualgit.readthedocs.io/en/latest/pages/naming_convention.html).
